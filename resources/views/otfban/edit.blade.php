...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Form Edit OTF Ban</h5>

                    <form action="{{ route('otfban.update', $otfban->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cabang_id" id="cabang_id" class="form-select select2 @error('cabang_id') is-invalid @enderror" data-placeholder="Pilih Cabang" required>
                                        ...
                                        @foreach($cabangs as $cabang)
                                            <option value="{{ $cabang->id }}" {{ old('cabang_id', $otfban->cabang_id) == $cabang->id ? 'selected' : '' }}>
                                                {{ $cabang->nama_cabang }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="ban_id" id="ban_id" class="form-select select2 @error('ban_id') is-invalid @enderror" data-placeholder="Pilih Ban" required>
                                        <option value=""></option>
                                        @foreach($bans as $ban)
                                            <option value="{{ $ban->id }}" {{ old('ban_id', $otfban->ban_id) == $ban->id ? 'selected' : '' }}>
                                                {{ $ban->kode_ban }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kendaraan_id" id="kendaraan_id" class="form-select select2 @error('kendaraan_id') is-invalid @enderror" data-placeholder="Pilih Kendaraan" required>
                                        ...
                                        @foreach($kendaraans as $kendaraan)
                                            <option value="{{ $kendaraan->id }}" {{ old('kendaraan_id', $otfban->kendaraan_id) == $kendaraan->id ? 'selected' : '' }}>
                                                {{ $kendaraan->nopol }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control @error('tanggal_otf') is-invalid @enderror" 
                                           id="tanggal_otf" name="tanggal_otf" value="{{ old('tanggal_otf', date('Y-m-d\TH:i', strtotime($otfban->tanggal_otf))) }}" required>
                                    @error('tanggal_otf')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('posisi_ban') is-invalid @enderror" 
                                           id="posisi_ban" name="posisi_ban" value="{{ old('posisi_ban', $otfban->posisi_ban) }}" required>
                                    @error('posisi_ban')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama_status_ban') is-invalid @enderror" 
                                           id="nama_status_ban" name="nama_status_ban" value="{{ old('nama_status_ban', $otfban->nama_status_ban) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('km_tempuh_otf') is-invalid @enderror" 
                                           id="km_tempuh_otf" name="km_tempuh_otf" value="{{ old('km_tempuh_otf', $otfban->km_tempuh_otf) }}" required>
                                    @error('km_tempuh_otf')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('ketebalan') is-invalid @enderror" 
                                           id="ketebalan" name="ketebalan" value="{{ old('ketebalan', $otfban->ketebalan) }}" required>
                                    @error('ketebalan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
